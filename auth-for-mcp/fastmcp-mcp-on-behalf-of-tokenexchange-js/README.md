# Example FastMCP MCP JS Server with Auth0 for On-Behalf-Of Token Exchange
...
- `greet` - Personalized greeting with On-Behalf-Of Token Exchange demo that calls the upstream API
