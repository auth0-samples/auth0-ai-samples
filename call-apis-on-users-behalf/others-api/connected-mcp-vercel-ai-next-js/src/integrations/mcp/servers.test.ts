...
import { loadMcpServers, NOTION_MCP_SERVER, GITHUB_MCP_SERVER, LINEAR_MCP_SERVER, ATLASSIAN_MCP_SERVER } from './servers';
...
describe('loadMcpServers', () => {
  ...
  it('pairs each server with an Auth0 connection used for the Token Vault exchange', () => {
    const [notion, github, linear, atlassian] = loadMcpServers({});
