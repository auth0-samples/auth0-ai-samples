...
You can setup a new Auth0 tenant with Token Vault enabled following the instructions [here](https://auth0.com/ai/docs/get-started/call-your-apis-on-users-behalf).
